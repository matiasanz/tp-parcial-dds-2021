...
public class ProveedorDeLocales {
    ...
    public static Local leble(){
        Local local2 = new Local("Leble", new Direccion("por ahi"), contactoStub(), CategoriaLocal.DE_AUTOR);
        local2.agregarPlato(platoStub);
        return local2;
    }

    public static Local mcConals(){
        Local local3 = new Local("McConals", new Direccion("alla a la vuelta"), contactoStub(), CategoriaLocal.COMIDA_RAPIDA);
        return local3;
    }
}
